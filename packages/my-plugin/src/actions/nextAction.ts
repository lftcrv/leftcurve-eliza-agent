...
const possibleActions = [
    { name: "HELLO_WORLD", description: "Make a cool Hello World ASCII art." },
    { name: "CURRENT_NEWS", description: "Get the current news for a search term if asked by the user." },
    { name: "PROVIDE_INFO", description: "Donner des informations." },
    { name: "WAIT", description: "Attendre une réponse de l'utilisateur." },
];
...
export const nextAction: Action = {
    name: "NEXT_ACTION",
    similes: ["NEXT_STEP", "KEEP_WORKING"],
    description:
        "Use this action when the current task involves multiple steps requiring sequential actions or messages to achieve completion. Evaluate the recent context of the conversation carefully to determine the appropriate next step, which may include waiting for the user's response.",
