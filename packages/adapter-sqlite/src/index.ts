    ...
    async initSimulatedWallet(agentID: UUID): Promise<void> {
        const sql = `
            INSERT INTO agent_balances (
                ...
                ?, -- agentID
                500000000000000000000, 10000000, 164000000000000000, 150000000000000000000, 1000000000000000000000, 0, 230000, 5000000000000000000, 0, 0, 0, 0, 0, 0, 400000000000000000000, 600000000, 250000000000000000000
            )
